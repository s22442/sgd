...
dist/Ball.o: src/Ball.cpp src/config.h
	$(DIST); $(CC) -c -o dist/Ball.o src/Ball.cpp $(CFLAGS)

dist/Brick.o: src/Brick.cpp src/config.h
	$(DIST); $(CC) -c -o dist/Brick.o src/Brick.cpp $(CFLAGS)

dist/CollisionObject.o: src/CollisionObject.cpp src/config.h
	$(DIST); $(CC) -c -o dist/CollisionObject.o src/CollisionObject.cpp $(CFLAGS)

dist/GameObject.o: src/GameObject.cpp src/config.h
	$(DIST); $(CC) -c -o dist/GameObject.o src/GameObject.cpp $(CFLAGS)

dist/Message.o: src/Message.cpp src/config.h
	$(DIST); $(CC) -c -o dist/Message.o src/Message.cpp $(CFLAGS)

dist/Platform.o: src/Platform.cpp src/config.h
	$(DIST); $(CC) -c -o dist/Platform.o src/Platform.cpp $(CFLAGS)

dist/ReflectiveObject.o: src/ReflectiveObject.cpp src/config.h
...
dist/main.o: src/main.cpp src/config.h
